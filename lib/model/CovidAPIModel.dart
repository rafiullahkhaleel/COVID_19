...
CovidApiModel covidApiModelFromJson(String str) => CovidApiModel.fromJson(json.decode(str));
String covidApiModelToJson(CovidApiModel data) => json.encode(data.toJson());
class CovidApiModel {
  CovidApiModel({
      num? updated, 
      num? cases, 
...
CovidApiModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => CovidApiModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
